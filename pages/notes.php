...
<?php include('../header.php');?>
    ...
    ?>
    <h1 class="centered-title"><?php echo $categoryName?></h1>
            ...
            <?php foreach($notes as $note): ?>
                <div key="<?php echo $note["id"]?>" class="note-card">
                    <a href="./note.php?noteTitle=<?php echo $note["title"]?>&noteDescription=<?php echo $note["description"]?>&dateModified=<?php echo $note["dateModified"]?>&noteId=<?php echo $note["id"]?>&category=<?php echo $_GET["category"]; ?>&categoryId=<?php echo $_GET["categoryId"];?>">
                        ...
                        <a href="./edit_note_page.php?noteId=<?php echo $note["id"] ?>&noteTitle=<?php echo $note["title"]?>&noteDescription=<?php echo $note["description"]?>&category=<?php echo $_GET["category"]; ?>&categoryId=<?php echo $_GET["categoryId"];?>"><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/6/64/Edit_icon_%28the_Noun_Project_30184%29.svg/1024px-Edit_icon_%28the_Noun_Project_30184%29.svg.png" class="garbage-image"></a>
                    </a>
                </div>
